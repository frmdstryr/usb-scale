...
pub const dirs = struct {
    pub const _root = "";
    pub const _jwh034b0atjd = cache ++ "/../..";
    pub const _deeztnhr07fk = "/home/jrm/projects/zgt";//cache ++ "/git/github.com/zenith391/zgt";
};

pub const package_data = struct {
    pub const _jwh034b0atjd = Package{
        .directory = dirs._jwh034b0atjd,
    };
